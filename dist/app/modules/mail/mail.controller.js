...
const insertIntoDB = (0, catchAsync_1.default)(async (req, res) => {
    const data = req.body;
    const result = await mail_service_1.MailService.insertIntoDB(data);
...
const getAllData = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const result = await mail_service_1.MailService.getAllData(paginationOptions);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const getSingleData = (0, catchAsync_1.default)(async (req, res) => {
    const result = await mail_service_1.MailService.getSingleData(req.params.id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const countAllData = (0, catchAsync_1.default)(async (req, res) => {
    const result = await mail_service_1.MailService.countAllData();
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const updateById = (0, catchAsync_1.default)(async (req, res) => {
    const { id } = req.params;
    const data = req.body;
    const result = await mail_service_1.MailService.updateById(id, data);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const deleteById = (0, catchAsync_1.default)(async (req, res) => {
    const result = await mail_service_1.MailService.deleteById(req.params.id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
