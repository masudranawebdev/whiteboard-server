...
const insertIntoDB = (0, catchAsync_1.default)(async (req, res) => {
    const data = req.body;
    const result = await mission_service_1.MissionService.insertIntoDB(data);
...
const getAllData = (0, catchAsync_1.default)(async (req, res) => {
    const result = await mission_service_1.MissionService.getAllData();
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const getSingleData = (0, catchAsync_1.default)(async (req, res) => {
    const result = await mission_service_1.MissionService.getSingleData(req.params.id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const updateById = (0, catchAsync_1.default)(async (req, res) => {
    const { id } = req.params;
    const data = req.body;
    const result = await mission_service_1.MissionService.updateById(id, data);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const deleteById = (0, catchAsync_1.default)(async (req, res) => {
    const result = await mission_service_1.MissionService.deleteById(req.params.id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
